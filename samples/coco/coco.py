...
class CocoConfig(Config):
    ...
    # Number of classes (including background)               ##### 本项目中只用行人和车辆类别 #####
...
if __name__ == '__main__':
    ...
    if args.command == "train":
        ...
        # validation set, as as in the Mask RCNN paper.
                # ...existing code...
        # 只用行人和车辆类别
        PEDESTRIAN_VEHICLE_CLASS_IDS = [1, 2, 3, 4, 6, 8]
        
        dataset_train = CocoDataset()
        dataset_train.load_coco(
            args.dataset, "train", year=args.year, 
            class_ids=PEDESTRIAN_VEHICLE_CLASS_IDS, 
        ...
        dataset_val.load_coco(
            args.dataset, val_type, year=args.year, 
            class_ids=PEDESTRIAN_VEHICLE_CLASS_IDS, 
            auto_download=args.download
        )
        dataset_val.prepare()
